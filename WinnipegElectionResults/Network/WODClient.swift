...
//        case getMemberPhoto(String)
        ...
        var stringValue: String
        {
            switch self
            {
            case .getGeneralElections: return Endpoints.base + Endpoints.electionDataset + "?type=General%20Election"
            case .getByElections: return Endpoints.base + Endpoints.electionDataset + "?type=By-Election"
